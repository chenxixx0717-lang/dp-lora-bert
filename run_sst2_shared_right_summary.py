...
def main():
    ...
    parser.add_argument("--plan_csv", type=str, default="shared_right_train_plan.csv")
    ...
    out_csv = plan_csv.with_name("shared_right_result_detail.csv")
    ...
    print(f"Saved summary detail: {out_csv}")
